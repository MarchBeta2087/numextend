...
for %%t in (test_bigint_bin test_bigint_dec test_bigfrac test_bigfloat test_bigfloat_fuzz test_rounding_tie test_bigdecimal test_bigcomplex_float test_bigcomplex_decimal test_convert) do (
